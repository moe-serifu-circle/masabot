...
class MasaBot(object):
	...
	def run(self):
		...
		self._primary_timer_task = self.client.loop.create_task(self._run_timer())
	...
	async def quit(self, api: 'PluginAPI', restart_command="quit"):
		...
		self._primary_timer_task.cancel()
	...
	async def _run_timer(self):
		...
		_log.debug("Primary timer started")
